...
//	PropData_Color		(PROPID_COLOR,		IDS_PROP_COLOR,			IDS_PROP_COLOR_INFO),
	PropData_CheckBox	(PROPID_CHECK_SPEECH_ENABLED,		IDS_PROP_CHECK_SPEECH_ENABLED,			IDS_PROP_CHECK_SPEECH_ENABLED_INFO),
...
//	// Return 0 (unchecked) or 1 (checked)
	case PROPID_CHECK_SPEECH_ENABLED:
		return edPtr->speechEnabled;
	}
